...
win_esc_arq = janelasm.make_win_esc_arq()
...
if event == "Inserir":
    ...
    if os.path.isfile(arquivo_dir):
        arquivo_manip = Modulo.ArquivoTexto(arquivo_dir)
        win_esc_arq.close()
        
        win_menu = janelasm.make_win_menu()
        ...
        while True:
            ...
            if event in (None, "Sair"):
                ...
                win_menu.Hide()
                win_palavra = janelasm.make_win_palavra()
                ...
                win_menu.Hide()
                win_pdf_senha = janelasm.make_win_senha_pdf()
                ...
                if event in (None, "Cancelar"):
                    ...
                    mensagem = arquivo_manip.gerarsenha_pdf(senha_pdf)
                    sg.popup(mensagem)
                    win_pdf_senha.close()
                ...
                win_menu.Hide()
                win_realocar = janelasm.make_win_realocar()
                ...
                win_menu.Hide()
                win_renomear = janelasm.make_win_renomear()
    ...
    else: sg.popup("Não foi inserido um diretório válido!")            